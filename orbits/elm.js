...
{
	if (region.ah.P === region.ao.P)
	{
		return 'on line ' + region.ah.P;
	}
	return 'on lines ' + region.ah.P + ' through ' + region.ao.P;
}
...
var author$project$Main$RungeKutta = 1;
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ad: oldTime, aG: request, aJ: subs};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ar: fragment, as: host, ay: path, aA: port_, aD: protocol, aE: query};
	});
...
var author$project$Main$makeAllNextValueCurrentOnes = function (objectList) {
	if (!objectList.b) {
		return _List_Nil;
	} else {
		...
		return (object.p === 'the sun') ? A2(
			...
			_Utils_update(
				object,
				{c: object.l, k: object.m}),
			author$project$Main$makeAllNextValueCurrentOnes(t));
	}
};
var author$project$Main$addVectors = F2(
	function (vector1, vector2) {
		return {a: vector1.a + vector2.a, b: vector1.b + vector2.b};
	});
var author$project$Main$gravityConstant = 0.1;
var author$project$Main$multiplyVectorByNumber = F2(
	function (_n0, f) {
		var x = _n0.a;
		var y = _n0.b;
		return {a: x * f, b: y * f};
...
var author$project$Main$vectorAbs = function (vector) {
	return elm$core$Basics$sqrt(
		A2(elm$core$Basics$pow, vector.a, 2) + A2(elm$core$Basics$pow, vector.b, 2));
};
var author$project$Main$vectorDiff = F2(
	function (vector1, vector2) {
		return {a: vector1.a - vector2.a, b: vector1.b - vector2.b};
	});
var author$project$Main$calculateAcceleration = F2(
	function (object1, listOfOtherObjects) {
		if (!listOfOtherObjects.b) {
			return A2(author$project$Main$Vector, 0, 0);
		} else {
			var h = listOfOtherObjects.a;
			var t = listOfOtherObjects.b;
			var r2 = h.c;
			var r1 = object1.c;
			var r12 = A2(author$project$Main$vectorDiff, r2, r1);
			var m = h.j;
			var absR12 = author$project$Main$vectorAbs(r12);
			return A2(
				author$project$Main$addVectors,
				A2(
					author$project$Main$multiplyVectorByNumber,
					r12,
					(author$project$Main$gravityConstant * m) / A2(elm$core$Basics$pow, absR12, 3)),
				A2(author$project$Main$calculateAcceleration, object1, t));
		}
	});
var author$project$Main$rungeKuttaIntegrateObj = F3(
	function (listOfOtherObjects, tObject, dt) {
		var v0 = tObject.k;
		var t0 = 0;
		var t1 = t0 + (dt / 2);
		var t2 = t0 + (dt / 2);
		...
		var f2 = F3(
			function (t, r, v) {
				return A2(
					author$project$Main$calculateAcceleration,
					_Utils_update(
						tObject,
						{c: r, k: v}),
					listOfOtherObjects);
		...
		var v1 = A2(
			author$project$Main$addVectors,
			v0,
			A2(author$project$Main$multiplyVectorByNumber, l1, 0.5));
		var f1 = F3(
			function (t, r, v) {
				return v;
			});
		...
		var r1 = A2(
			author$project$Main$addVectors,
			r0,
			A2(author$project$Main$multiplyVectorByNumber, k1, 0.5));
		var l2 = A2(
			author$project$Main$multiplyVectorByNumber,
			A3(f2, t1, r1, v1),
			dt);
		var v2 = A2(
			author$project$Main$addVectors,
			v0,
			A2(author$project$Main$multiplyVectorByNumber, l2, 0.5));
		var k2 = A2(
			author$project$Main$multiplyVectorByNumber,
			A3(f1, t1, r1, v1),
			dt);
		var r2 = A2(
			author$project$Main$addVectors,
			r0,
			A2(author$project$Main$multiplyVectorByNumber, k2, 0.5));
		var l3 = A2(
			author$project$Main$multiplyVectorByNumber,
			A3(f2, t2, r2, v2),
			dt);
		var v3 = A2(author$project$Main$addVectors, v0, l3);
		var k3 = A2(
			author$project$Main$multiplyVectorByNumber,
			A3(f1, t2, r2, v2),
			dt);
		var r3 = A2(author$project$Main$addVectors, r0, k3);
		var l4 = A2(
			author$project$Main$multiplyVectorByNumber,
			A3(f2, t3, r3, v3),
			dt);
		...
		var deltaV = A2(
			...
			A2(
				...
				A2(
					author$project$Main$addVectors,
					A2(author$project$Main$multiplyVectorByNumber, l3, 2),
					A2(
						author$project$Main$addVectors,
						A2(author$project$Main$multiplyVectorByNumber, l2, 2),
						l1))),
			1 / 6);
		var newVelocity = A2(author$project$Main$addVectors, v0, deltaV);
		var deltaR = A2(
			author$project$Main$multiplyVectorByNumber,
			A2(
				author$project$Main$addVectors,
				...
				A2(
					author$project$Main$addVectors,
					A2(author$project$Main$multiplyVectorByNumber, k3, 2),
					A2(
						author$project$Main$addVectors,
						A2(author$project$Main$multiplyVectorByNumber, k2, 2),
						k1))),
			1 / 6);
		var newCoordinates = A2(author$project$Main$addVectors, r0, deltaR);
		return _Utils_update(
			tObject,
			{l: newCoordinates, m: newVelocity});
	});
...
var author$project$Main$integrateAllObjects = F2(
	function (dt, objectList) {
		var helper = function (objsLeft) {
			if (!objsLeft.b) {
				return _List_Nil;
			} else {
				var h = objsLeft.a;
				...
				var otherObjects = A2(
					...
					function (o) {
						return !_Utils_eq(o, h);
					},
					objectList);
				return A2(
					elm$core$List$cons,
					A3(author$project$Main$rungeKuttaIntegrateObj, otherObjects, h, dt),
					helper(t));
			}
		};
		return author$project$Main$makeAllNextValueCurrentOnes(
			helper(objectList));
	});
var author$project$Main$integrateNTimes = F3(
	function (times, step, objectList) {
		integrateNTimes:
		while (true) {
			if (!times) {
				return objectList;
				...
				var $temp$times = times - 1,
					$temp$step = step,
					$temp$objectList = A2(author$project$Main$integrateAllObjects, step, objectList);
				times = $temp$times;
				step = $temp$step;
				objectList = $temp$objectList;
				continue integrateNTimes;
			}
		}
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				var dt = msg.a;
				var intObjects = A3(author$project$Main$integrateNTimes, model.N, model.T, model.R);
				var updatedModel = _Utils_update(
					model,
					{C: model.C + 1, R: intObjects});
			...
			default:
				var newStep = A2(
					...
					model.T,
					elm$core$String$toFloat(model.U));
				var newIntegration = A2(
					elm$core$Maybe$withDefault,
					model.N,
					elm$core$String$toInt(model.O));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{N: newIntegration, T: newStep}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var joakin$elm_canvas$Canvas$shapes = F2(
	function (settings, ss) {
		return A2(
			...
			{
				v: _List_Nil,
				L: joakin$elm_canvas$Canvas$NotSpecified,
				M: joakin$elm_canvas$Canvas$DrawableShapes(ss)
			});
	});
...
var author$project$Main$integrationMethodToString = function (integrationMethod) {
...
var author$project$Main$drawObjects = function (objectList) {
	if (!objectList.b) {
		return _List_Nil;
	} else {
		var h = objectList.a;
		...
		return A2(
			...
			A2(
				...
				_Utils_Tuple2(h.c.a * 10, h.c.b * 10),
				elm$core$Basics$sqrt(
					elm$core$Basics$sqrt(h.j))),
			author$project$Main$drawObjects(t));
	}
};
...
var author$project$Main$render = function (model) {
	...
	var x = -(size / 2);
	var y = -(size / 2);
	var rotation = elm$core$Basics$degrees(model.C * 3);
	var hue = A2(
		elm$core$Basics$modBy,
		100,
		elm$core$Basics$floor(model.C / 4)) / 100;
	return A2(
		joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
		...
		author$project$Main$drawObjects(model.R));
};
...
var joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$fillText, txt._, x, y, txt.Q),
			A2(
				elm$core$List$cons,
...
var joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			elm$core$List$cons,
			A4(joakin$elm_canvas$Canvas$Internal$strokeText, txt._, x, y, txt.Q),
			A2(
				elm$core$List$cons,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$ToggleClear)
							]),
						_List_fromArray(
							[
								elm$html$Html$text(
								model.B ? 'Leave traces' : 'Refresh screen')
							])),
						elm$html$Html$text(
						'Current integration method: ' + author$project$Main$integrationMethodToString(model.Z)),
						elm$html$Html$text('Integration step:'),
						A2(
						elm$html$Html$input,
						_List_fromArray(
							[
								elm$html$Html$Events$onInput(author$project$Main$UpdateStep),
								elm$html$Html$Attributes$value(model.U)
							]),
						_List_Nil),
						elm$html$Html$text('Integrations per frame:'),
						A2(
						elm$html$Html$input,
						_List_fromArray(
							[
								elm$html$Html$Events$onInput(author$project$Main$UpdateIntegration),
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$SetValues)
							]),
						_List_fromArray(
							[
...
var author$project$Main$main = elm$browser$Browser$element(
	{a$: author$project$Main$init, ba: author$project$Main$subscriptions, bc: author$project$Main$update, be: author$project$Main$view});
